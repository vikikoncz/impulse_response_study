...
#MY_LINE=$(ps -ax | grep java_run2.sh | sed 's/^\(.....\).*/\1/;q')
#echo ${MY_LINE}
#kill -9 ${MY_LINE} 


#MY_LINE=$(ps -ax | grep comsollauncher | sed 's/^\(.....\).*/\1/;q')
#MY_LINE=$(ps | grep gedit | sed 's/^\(([0-9])....\).*/\1/;q')
#echo ${MY_LINE}
#kill -9 ${MY_LINE}


#MY_LINE=$(ps -ax | grep comsol | sed 's/^\(.....\).*/\1/;q')
#echo ${MY_LINE}
#kill -9 ${MY_LINE} 

killall java_run2.sh
killall comsol
killall comsollauncher
